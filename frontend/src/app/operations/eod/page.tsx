  ...
  return (
    <div className="space-y-6 w-full max-w-[96%] xl:max-w-[1400px] mx-auto pb-20">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto items-center">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                <Button 
                  ...
                  variant="outline"
                  className="border-slate-200 hover:bg-slate-50 text-slate-700 font-black uppercase tracking-widest text-[9px] h-9 px-4 rounded-xl flex items-center gap-1.5 cursor-pointer shadow-sm shrink-0"
                >
                  <Users className="w-3.5 h-3.5 text-blue-600" /> Existing Customers
                </Button>
                        ...
                        <TableCell className="px-6 py-4">
                          ...
                          {(() => {
                            ...
                            if (cust) {
                              ...
                              return (
                                <button 
                                  onClick={() => openAddCustomerModal(item.bill_no)}
      ...
      <Dialog open={showCustomerRegistryModal} onOpenChange={setShowCustomerRegistryModal}>
        <DialogContent className="sm:max-w-[750px] glass p-0 rounded-[2rem] border-white/40 max-h-[85vh] flex flex-col overflow-hidden">
          <div className="h-2 bg-blue-600 shrink-0" />
