    ...
    <div className="space-y-6 max-w-7xl mx-auto p-2 sm:p-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black tracking-tight text-slate-900">CCTV Activity Audit Logs</h1>
              <p className="text-sm font-semibold text-slate-500">Immutable audit log tracking all video playbacks, downloads, live stream views, and PTZ controls</p>
            </div>
          </div>
          <button onClick={fetchLogs} className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2">
        ...
        <Card className="border-slate-200 shadow-sm rounded-2xl overflow-hidden">
          <CardHeader className="bg-slate-50/50 border-b border-slate-200/80">
            <CardTitle className="text-base font-bold text-slate-800">Security Trail ({logs.length})</CardTitle>
