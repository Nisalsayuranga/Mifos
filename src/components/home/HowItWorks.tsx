...
const STEPS = [
  ...
  { n: 2, icon: ShieldCheck, title: "Verify", desc: "Every listing on RUPASINGHE REALTY is reviewed and verified by our team. Know exactly what you are buying.", color: "bg-emerald-100 text-emerald-800" },
  { n: 3, icon: Users, title: "Connect", desc: "Speak directly with sellers, schedule viewings, and consult with our network of expert agents.", color: "bg-emerald-50 text-emerald-700" },
  { n: 4, icon: ArrowRight, title: "Move Forward", desc: "From valuation to financing, RUPASINGHE REALTY supports you at every step of your property journey.", color: "bg-primary/15 text-primary" },
];
    ...
    <section className="py-20 bg-muted/40">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground font-heading">How RUPASINGHE REALTY Works</h2>
