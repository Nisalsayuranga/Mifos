  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="bg-gradient-to-br from-[#013B30] to-[#00261F] rounded-2xl overflow-hidden shadow-xl">
          <div className="grid md:grid-cols-2 gap-0">
            <div className="p-10 md:p-14">
              <p className="text-[#E8D196] text-sm font-semibold uppercase tracking-widest mb-3">Financing Partners</p>
              <h2 className="text-3xl font-bold text-white font-heading mb-4">Explore Property Financing Options</h2>
              <p className="text-white/80 leading-relaxed mb-6">
                RUPASINGHE REALTY connects eligible buyers with Sri Lanka&apos;s leading financial institutions. Get pre-approved and move faster on your dream property.
              </p>
              <ul className="space-y-2.5 mb-8">
                {BENEFITS.map((b) => (
                  <li key={b} className="flex items-center gap-2.5 text-white/90 text-sm">
                    <CheckCircle className="w-4 h-4 text-emerald-300 shrink-0" /> {b}
                  </li>
                ))}
              </ul>
              <Link href="/financing">
                <Button className="bg-white hover:bg-white/90 text-primary font-bold px-7 h-11 rounded-xl shadow-md">
